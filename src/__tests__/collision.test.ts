...
describe('findNearestEnemy', () => {
  const base = { hp: 10, maxHp: 10, type: 'slow' as const, soakedUntil: 0, frozenUntil: 0, burningUntil: 0, poisonedUntil: 0, slowedUntil: 0, stunnedUntil: 0, knockback: null, hitFlashUntil: 0, resistAuraUntil: 0, dying: false, detonating: false }
  const enemies = [
