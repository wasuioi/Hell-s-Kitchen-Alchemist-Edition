...
export const PERK_POOL: PerkDefinition[] = [
  ...
  { id: 'double_batch', name: 'Double Batch', icon: '🧪', description: '10% chance spell triggers twice', rarity: 'epic' },
  {
    ...
    tiers: [
      { stats: { Damage: 15, Radius: 4, Cooldown: '2.0s' } },
      { stats: { Damage: 25, Radius: 5, Cooldown: '1.5s' }, added: 'Soaks enemies for 1.5s' },
      { stats: { Damage: 40, Radius: 6, Cooldown: '1.0s' }, added: 'Doubles damage on heavy hits, stuns instead of soaks' },
    ],
  },
]
